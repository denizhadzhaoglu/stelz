...
When detected=true, return bounding box(es) pointing to the STELZ product(s) in the user post image. Use Gemini's standard normalized 0-1000 coordinate space, ordered [y1, x1, y2, x2] from top-left. One bbox per visible STELZ product/can/banner. Do not invent boxes when detected=false.
